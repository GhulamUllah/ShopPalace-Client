...
export default function Success() {
    ...
    useEffect(() => {
        dispatch(updatepayment(order?._id))
    }, [order])
    return (
        <Box sx={{ p: 3 }}>
            <Paper elevation={3} sx={{ p: 2 }}>
                <Typography variant='h5' sx={{ color: 'primary.main', fontWeight: 600, textAlign: 'center', textDecoration: 'underline dotted #467540' }}>Order Successfull</Typography>
                <Table>
                    <TableBody>
                        <TableRow>
